...
export const SAMPLE_PRESETS = [
  {
    id: 'user_recaptcha_modal',
    name: 'Bot vs Human Modal Edit',
    category: 'AI Inpainting',
    tag: 'Text Inpainting',
    thumbnail: '/recaptcha_edited.png',
    type: 'user_pair',
    description: 'White reCAPTCHA dialog where "ROBOT" was edited to "HUMAN" by diffusion inpainting.',
  },
  {
    id: 'user_desert_path',
    name: 'Desert Road Modification',
    category: 'AI Inpainting',
    tag: 'Object Insertion',
    thumbnail: '/sand_path_road_red.png',
    type: 'user_pair',
    description: 'Landscape photograph where a natural sand path was replaced with red brick pavers.',
  },
  {
    id: 'inpainting_edit',
    name: 'Synthetic Object Splice',
    category: 'Object Splicing',
    tag: 'Ground Truth',
    thumbnail: '/sand_path_road_red.png',
    type: 'inpainting',
    description: 'Generative insertion tested against exact pixel mask ground truth.',
  },
  {
    id: 'screenshot_edit',
    name: 'Screen-Captured Inpainting',
    category: 'Screenshot Capture',
    tag: 'Zero Metadata',
    thumbnail: '/recaptcha_edited.png',
    type: 'screenshot_inpainting',
    description: 'PNG snippet capture testing pixel-level noise resilience without EXIF tags.',
  },
  {
    id: 'authentic_photo',
    name: 'Camera Photograph Control',
    category: 'Camera Original',
    tag: 'Authentic Control',
    thumbnail: '/sand_path_original.jpg',
    type: 'authentic',
    description: 'Raw camera capture displaying physical sensor shot noise and uniform Bayer demosaicing.',
  },
  {
    id: 'full_synthetic',
    name: 'Full-Canvas Diffusion',
    category: 'AI Generation',
    tag: '100% Synthetic',
    thumbnail: '/chatgpt_test.png',
    type: 'full_ai',
    description: 'Completely synthetic AI diffusion generation displaying spectral frequency anomalies.',
  }
];
