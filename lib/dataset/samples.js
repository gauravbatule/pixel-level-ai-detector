...
export const SAMPLE_PRESETS = [
  {
    ...
    tag: 'White Box Text Inpaint',
    type: 'user_pair',
    description: 'Screenshot where the white reCAPTCHA modal text "ROBOT" was edited to "HUMAN" by AI.',
  },
  {
    id: 'user_desert_path',
    name: '🌵 Desert Red Road Edit',
    tag: 'Desert Road Paired',
    type: 'user_pair',
