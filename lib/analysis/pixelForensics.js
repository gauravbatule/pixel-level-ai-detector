...
export function performPixelForensics(imageData, width, height, isScreenshotOrLossless = false, mode = 'balanced') {
  ...
  // --- 2. Inter-Channel Seam Discontinuity (Sobel on Color Delta) ---
  ...
  // --- 3. Multi-Color Chromatic & Floral Inpainting Anomaly ---
  ...
  for (let i = 0; i < numPixels; i++) {
    ...
    // Purple / Magenta / Pink flowers (R & B high, G depressed)
  ...
  // --- 4. Inpainted Modal Box Detector (Large solid white cards, suppressed on full-page white documents) ---
