...
async function run() {
  ...
  console.log("High-Pass Residual Chroma Correlation r(R, B):", chroma.rRB);
  console.log("High-Pass Residual Chroma Correlation r(R, G):", chroma.rRG);
  console.log("Raw Dimensions:", metadata.width, "x", metadata.height);
  console.log("Noise Variance:", noiseRes.stats.averageNoiseVariance);
  console.log("Smooth Ratio:", noiseRes.stats.smoothRatio);
  console.log("BNC:", noiseRes.stats.brightnessNoiseCorrelation);
  console.log("Cross Channel:", noiseRes.stats.crossChannelScore);
  console.log("High Freq Ratio:", freqRes.stats.averageHighFreqRatio);
}
