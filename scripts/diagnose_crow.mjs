...
const crowPath = "C:/Users/Gaurav Batule/.gemini/antigravity/brain/d01aa755-7a0f-416c-b273-8ef496152c7d/.user_uploaded/media_1787424162222.jpg";

async function diagnose() {
  const image = sharp(crowPath);
  ...
  console.log("================================================================================");
  console.log("  CROW INFOGRAPHIC FORENSIC FEATURE EXTRACTION");
  console.log("================================================================================");
  ...
  // Check dark background / layout features
  // In infographics: Dark panels, discrete text boxes, AI rendered crow
  let darkPanelPixels = 0;
  for (let i = 0; i < info.width * info.height; i++) {
    const idx = i * 4;
    const lum = 0.299 * data[idx] + 0.587 * data[idx+1] + 0.114 * data[idx+2];
    if (lum < 35) darkPanelPixels++;
  }
  console.log(`\n--- Layout / Composition Features ---`);
  console.log(`  Dark Background / Panels:  ${(darkPanelPixels / (info.width * info.height) * 100).toFixed(1)}%`);
}
